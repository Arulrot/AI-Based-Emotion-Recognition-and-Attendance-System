    ...
    # Define emotion labels
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                # Reshape the image to match the input shape of the model r̥
...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'iamarulmohan333@gmail.com' ")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='Some file is missing', message='Please contact us for help')
        window.destroy()
...
def open_image():
    ...
    window = tk.Tk()
    window.title("FEAR AI")
    
    # Open the image using PIL
    image = Image.open("C:/Users/arulmohan/OneDrive/Desktop/Logo1.jpg")
    ...
    # Resize the window and position it in the center
...
message3 = tk.Label(window, text="Face Expression Attendance Recognition AI  System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"|", fg="orange",bg="#262523" ,width=100 ,height=2,font=('times', 22, ' bold '))
...
quitWindow = tk.Button(frame1, text="Quit", command=lambda:close() ,fg="black"  ,bg="red"  ,width=35 ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
